...
public class AESTypeRsaAlgorithms implements AbstractDecryption,AbstractEncryption {
  ...
  public static void main(String[] args)
  {
    ...
    String encryptedString = AESTypeRsaAlgorithms.encrypt(originalString, secretKey) ;
    String decryptedString = AESTypeRsaAlgorithms.decrypt(encryptedString, secretKey) ;
